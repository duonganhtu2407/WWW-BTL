            ...
            success: function (result) {
            	if(!result.validated){
            		...
            		if(result.alert=='exist'){
                		window.location.href="<c:url value='/admin/user/add'/>"+"?message=error_account_exist";
                	}else{
                		window.location.href = "<c:url value='/admin/user/add/'/>"+result.id+"?message=insert_success";
                	}
            	}
            },
